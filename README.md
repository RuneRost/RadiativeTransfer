...
This is an ODE that can be solved analytically (or numercially). In [RTE_spherical_symmetry](/RTE_spherical_symmetry.ipynb) I implemented an analytic and a numeric solution which can be used to generate training data.
